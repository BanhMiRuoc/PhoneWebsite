$(document).ready(function () {
    ...
    for (var i = 0; i < products.length; i++) {
        ...
        var productHTML = '<div class="col-md-3 mb-4">' +
            '<div class="card d-flex align-items-center p-2" style="width: 100%;">' +
            '<img class="card-img-top" src="' + products[i].imgSrc + '" alt="Card image cap" style="height: 16rem; width: calc(100% - 5rem);">' +
            '<div class="card-body">' +
            '<h5 class="card-title mt-2">' + products[i].title + '</h5>' +
            '<div class="test">' +
