...
if(isset($_POST['btn_add'])) {
    ...
    // Kiểm tra xem dữ liệu ảnh đã được gửi đi chưa
    // Lấy dữ liệu ảnh từ form và mã hóa nó thành dạng base64
    // $imageData = file_get_contents($_FILES['input_pictureLecture']['tmp_name']);
